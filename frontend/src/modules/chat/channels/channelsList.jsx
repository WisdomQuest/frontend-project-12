...
import { notifySuccess, notifyError } from '../../../common/utils/notify.js';
...
export const ChannelList = () => {
  ...
  return (
    <>
      <div className="d-flex mt-1 justify-content-between mb-2 ps-4 pe-2 p-4 overflow-hidden">
        <b className="overflow-hidden">{t('channels.title')}</b>
        <button
